...
from page3_sub import data_input1, data_input2, create_comparison_graph, MEF_comparison_graph
...
# 사이드바 메뉴
with st.sidebar:
    image_html1 = image_input('대표로고2.png','70%','100%','-80px','20px','center')
    if image_html1:
...
text_color = '#9da8ab'  # 두 번째 텍스트 색상

# Page logic
if st.session_state.selected_option == "대표 솔루션":
    with st.container():
        image_html1 = image_input('효과설명2.png','40%','60%','-70px','15px','left')
        if image_html1:
            st.markdown(image_html1, unsafe_allow_html=True)
        ...
        if not st.session_state.energy_value_season.empty:
            image_html1 = image_input('멘트.png', '50%', '100%', '0px', '30px', 'left')
            if image_html1:
                st.markdown(image_html1, unsafe_allow_html=True)
            ...
            with con1:
                ...
                create_comparison_graph(data, max_down_date, width=950, height=500)

            with con2:
                con2_1, con2_2 = st.columns([0.5, 0.5])
                    ...
                    st.markdown(
                        ...
                        <div class='centered con-margin' style='margin-top: 10px; padding: 30px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:70px; color:black; font-weight: bold;'>
                                {grouped_total_value} kgCO<sub class='large-sub'>2</sub>
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                ...
                with con2_2:
                    ...
                    st.markdown(
                        ...
                        <div class='centered con-margin' style='margin-top: 10px; padding: 30px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:70px; color:black; font-weight: bold;'>
                                {cal_Total1} kgCO<sub class='large-sub'>2</sub>
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                    ...
                    # cal_Total2=cal_Total2/40075
                    cal_Total2 = cal_Total2.round(0).astype(int)
                    cal_Total3 = cal_Total / 8
                    cal_Total3=cal_Total3.round(0).astype(int)

                con2_3,con2_4 = st.columns([0.2, 0.9])
                with con2_3:
                    st.write('')
                    image_html1 = image_input('차.png','60%','60%','0px','0px','center')
                    if image_html1:
                        st.markdown(image_html1, unsafe_allow_html=True)
                with con2_4:
                    st.markdown(
                        ...
                        <div class='centered con-margin' style='margin-top: 20px; padding: 20px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                자동차 주행거리 {cal_Total2} km로 배출되는 탄소량만큼 절감합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                    )
                con2_5,con2_6 = st.columns([0.2, 0.9])
                with con2_5:
                    st.write('')
                    image_html1 = image_input('나무.png','60%','60%','0px','0px','center')
                    if image_html1:
                        st.markdown(image_html1, unsafe_allow_html=True)
                with con2_6:
                    st.markdown(
                        ...
                        <div class='centered con-margin' style='margin-top: 20px; padding: 20px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                나무를 {cal_Total3} 그루 심는 것과 절감효과가 동일합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
            ...
            st.markdown(
                f"<hr style='border: 0.5px solid {hr_color}; margin-top: -10px; margin-bottom: -20px;'>",
                unsafe_allow_html=True)
            st.write(' ')
            ...
            st.markdown(
                f"<div class='centered con-margin' style='margin-top:-30px; margin-bottom: 0px;'><h2 style='font-size:30px; color:#9da8ab;'>다음달 전기사용량은 <span style='color:red;'>{df_energy_Total}</span> MWh정도이고, CO<sub class='large-sub'>2</sub>는 <span style='color:red;'>{selected_data_MEF_Total}</span> kgCO<sub class='large-sub'>2</sub> 절감될 것으로 예상됩니다.</h2></div>",
                unsafe_allow_html=True
            )
            st.write(' ')
            ...
            st.error("Energy value season data is not available. Please upload the CSV file by clicking the 'Click this!!' button.")
        st.markdown(
            f"<hr style='border: 2.0px solid {hr_color}; margin-top: -10px; margin-bottom: -10px;'>",
            unsafe_allow_html=True)
        ...
        if not st.session_state.energy_value_season.empty:
            ...
            with con1:
                ...
                with con1_1:
                    ...
                    st.markdown(
                        f"""
                        <div class='centered con-margin' style='margin-top: 10px; padding:5px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                ...
                with con2_4:
                    st.markdown(
                        f"""
                        <div class='centered con-margin' style='margin-top: 20px; padding: 10px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                자동차 주행거리 {season_MEF_total2} km로 배출되는 <br>탄소량만큼 절감합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                ...
                with con2_6:
                    st.markdown(
                        f"""
                        <div class='centered con-margin' style='margin-top: 10px; padding: 10px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                나무를 {season_MEF_total3} 그루 심는 것과 <br>절감효과가 동일합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
            ...
            with con2:
                predict_model_graph(data, width=1280, height=400)
            ...
            with con2:
                season_bar(energy_value_season, width=900, height=400)
            ...
            with con3:
                ...
                season_MEF_bar(season_MEF, width=900, height=400)
            ...
            with con1:
                ...
                with con2_4:
                    st.markdown(
                        ...
                        <div class='centered con-margin' style='margin-top: 20px; padding: 10px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                자동차 주행거리 {selected_data_MEF_Total1} km로 배출되는 <br>탄소량만큼 절감합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                ...
                with con2_6:
                    st.markdown(
                        f"""
                        <div class='centered con-margin' style='margin-top: 15px; padding: 10px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #FFFFFF; max-width: 100%; margin-left: auto; margin-right: auto;'>
                            <h2 style='font-size:25px; color:black; font-weight: bold;'>
                                나무를 {selected_data_MEF_Total2} 그루 심는 것과 <br>절감효과가 동일합니다.
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
                ...
                with con2:
                    create_comparison_graph(selected_data, selected_date, width=600, height=400)

                with con3:
                    MEF_comparison_graph(selected_data, selected_date, width=600, height=400)
...
if st.session_state.selected_option == "미래 솔루션 Detail":
    with st.container():
        ...
        if 'predict_data1' in st.session_state:
            ...
            st.markdown(
                f'<h2 style="font-size:24px; color:{title_color}; margin-top: 10px; margin-bottom: -10px; font-weight: bold;">1. 한달 예측 및 최적화 결과</h2>',
                unsafe_allow_html=True)
            st.markdown(
                f"<hr style='border: 0.5px solid {hr_color}; margin-top: -10px; margin-bottom: -10px;'>",
                unsafe_allow_html=True)
            ...
            with con1:
                ...
                with con1_1:
                    ...
                    st.markdown(
                        f"""
                        <div class='centered con-margin' style='margin-top: 0px; padding: 0px; border: 0px solid #9da8ab; border-radius: 50px; text-align: center; background-color: #848484;'>
                            <h2 style='font-size:30px; color:#FFFFFF; font-weight: bold;'>총 사용량
                            </h2>
                        </div>
                        """,
                        unsafe_allow_html=True
            ...
            with con2:
                predict_model_graph(df_energy_predict1, width=1350, height=400)
            ...
            with con1:
                ...
                with con1_2:
                    ...
                    selected_data_MEF_Total1 = selected_data_MEF_Total * 1000 / 74
                    selected_data_MEF_Total1 = selected_data_MEF_Total1.round(0).astype(int)
                    selected_data_MEF_Total2=selected_data_MEF_Total2/8
                    selected_data_MEF_Total2 = selected_data_MEF_Total2.round(0).astype(int)
            ...
            st.error("Predict data is not available.")
        st.markdown(
            f"<hr style='border: 2.0px solid {hr_color}; margin-top: -10px; margin-bottom: -10px;'>",
            unsafe_allow_html=True)
